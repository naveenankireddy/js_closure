...
final;// final should be "Will Smith"
...
function isInBetween(a, b) {
  // your code goes here
  return function condition(num){
    return num >= 10 && num <= 100 ? true : false;
  }
}
...
function letsWishThem(greeting) {
  return function wishThem(message){
